...
const int PYRAMID_VERTICES = 20;	// Total Number of Vertices
const int PYRAMID_INDICES = 10;	    // Total Number of Indexes
const int PYRAMID_UVS = 40; 	    // Total Number of UVs
